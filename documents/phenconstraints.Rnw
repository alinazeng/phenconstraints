...
%EMW: Review edits below. Also check caradonna cite comes through.
...
\begin{itemize}
%EMW: See edits, also -- does the slope have to be less than 1? I assume so, but did not think it through so wanted to make sure you had. We can discuss if needed. #Aske Lizzie: A slope greater than one would suggest a change in the rate of transition from one phenological event to the next. worth adding? seems tooo complicated to me!
...
%EMW: Should we also parallel weak/strong here? 
...
%EMW: Abundance is measured as percent? Abundance of phenology just sounds weird to me ... 
...
%EMW: See edits below. Also, what do you think of adding some examples from the discussion to the results? 
