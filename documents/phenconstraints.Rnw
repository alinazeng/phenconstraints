...
Plant phenology varies dramatically yet we do not understand what drives this variation. Different plant species vary widely in the timing of leaf out and other phenological processes, even when exposed to the same environmental conditions (Lechowicz, 1984). For example, spring leaf out can span weeks among coexisting tree species (Lechowicz, 1984). The drivers of these variations are poorly understood, even though phenology has been long-observed (Wolkovich & Ettinger, 2014). 
...
\section*{Authors’ contributions} All authors conceived and designed the study and edited the manuscript; S.G. conducted the field and lab work; S.G. and A.E. analyzed the data and wrote the manuscript.
