...
%EMW: Do you have the word count to restructure this a little to be more explicit in that there's lots of research but it tends to focus on one phenophase at a time meaning we know little about how these phases ....
Plant phenology is a critical trait as the timings of phenophases such as budburst, leafout, flowering, and fruiting, are important to plant fitness. Despite much study, little is known about how these phases relate to one another across an entire growing season. We test the extent to which early phenological stages constrain later ones, throughout a growing season and across 25 angiosperm tree species. 
\subsection*{Methods}
...
%EMW: I am not sure if you should call them co-occurring here ... that usually means (to me at least) co-occurring in the wild. Maybe just be clear in the methods section? Edit suggested below.
...
%EMW: small tweaks ... and, this is great! But why no R2 for senescence (as given for flowering)?
...
%EMW: If possible add a more clear transition here -- you're moving from a couple paragraphs on one topic to a NEW topic, help the reader with that transition if you can. 
...
\begin{figure}[p]
  ...
  \includegraphics{../analyses/figures/hypotheses3.pdf} 
    %EMW: I would adjust this figure to make sure you clarify you are discussing ACROSS species relationships. For example, say 'points below the fitted line represent a species that sets fruit ...' and say 'across species in the H1 or H2 descriptions.  
...
\end{figure}
  ...
  %EMW: Added missing r. Also, check your quotes!
