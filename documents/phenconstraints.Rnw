...
3. Phenological sequences: how early-season events define those that follow} %EMW: I like 3; I feel like 'sequence' and 'follow' go well together
...
%EMW: I would cite something beyond the Primack lab here; there are so many other options! Maybe the Cleland 2007 TREE paper?
 In temperate tree species, temperature is a major factor controlling phenology \citep{parmesan2006, morin2010,schwartz2013}. As such, recently observed temporal shifts in budburst, leafout, and other phenological states have been attributed to warming from anthropogenic climate change \citep{parmesan2006}. Phenology is expected to shift further with future climate change, and, because of its important role in many ecosystem services and in the global climate cycle, planning and preparing for climate change impacts will benefit from improved understanding and forecasting of tree phenology. %EMW: The order here feels hard on the reader, you return at the end to something set up in the beginning with a clause-rich sentence. I would consider re-writing; perhaps by diving directly into shifts with climate change as the second sentence so you can more quickly link the reader to the connection with planning and forecasting. Then you can discuss that temperature is a major cue but that it doesn't explain all the variation. You may need to delete the first clause of your next section but I think it would work better.
...
\item Hypothesis 2: Inter-phenophase time  constrains phenology; e.g., late-fruiting species set fruit late in the season because they require longer development and/or maturation time (Figure \ref{fig:hyp}). %EMW: Difference between development and maturation?
\end{itemize}
...
%EMW: It feels like you define phenology via the NPN in both paragraphs; can you condense? Or make why they are separated out more clear?
...
\section* {Results}
%EMW: Yes! A figure on in. variation sounds good. 
...
%EMW: Need to define/introduce ecological memory. 
...
\end{figure}
  ...
  %EMW: Define DOY in each caption where you use it.
  \begin{figure}[h]
  \centering
